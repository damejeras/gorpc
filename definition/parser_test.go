...
You will love it.`)
	...
	is.Equal(welcomeInputObject.Fields[1].Type.PHPType, "string")
	is.Equal(welcomeInputObject.Fields[1].Type.IsPointer, true)
	...
	is.Equal(welcomeInputObject.Fields[2].Type.PHPType, "float")
	is.Equal(welcomeInputObject.Fields[2].Type.IsPointer, false)
